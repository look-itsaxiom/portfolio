...
export function ChatWidget() {
  ...
  const [fallbackReply, setFallbackReply] = useState<string | null>(null)
  ...
  useEffect(() => {
    ...
    // Only start a new subscription from idle state
    ...
    es.onmessage = (event) => {
      try {
        ...
        if (data.event === "typing") {
          setFallbackStatus("typing" as FallbackStatus)
        } else if (data.event === "response") {
          // Replace the fallback message with Chase's actual reply
          setFallbackReply(data.text)
  ...
  }, [messages, fallbackStatus, setMessages])
  ...
  // Allow external code to open chat with a pre-filled prompt
  useEffect(() => {
      ...
      >
        <SheetHeader className="border-b px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <SheetTitle className="text-base">Ask Axiom</SheetTitle>
              <p className="text-xs text-muted-foreground">
                Your guide to Chase&apos;s work
              </p>
            </div>
          </div>
        </SheetHeader>
              ...
              <div className="space-y-4">
                <div className="rounded-lg bg-muted/50 p-4">
                  <p className="text-sm text-muted-foreground">
                    Hey! I&apos;m Axiom, the guide for Chase&apos;s portfolio.
                    Think of me as the museum guide who&apos;s genuinely excited
                    to show you around. Ask me anything!
                  </p>
                </div>
